...
public class RabbitConfig {
	 ...
	 * 延迟队列 TTL 名称
	 */
	private static final String REGISTER_DELAY_QUEUE = "dev.register.delay.queue";
	/**
	 * DLX，dead letter发送到的 exchange TODO 此处的 exchange 很重要,具体消息就是发送到该交换机的
	 */
	public static final String REGISTER_DELAY_EXCHANGE = "dev.register.delay.exchange";
	/**
	 ...
	 * “dog”，则只有被标记为“dog”的消息才被转发，不会转发dog.puppy，也不会转发dog.guard，只会转发dog。 TODO 它不像
	 * TopicExchange 那样可以使用通配符适配多个
	 *
	 ...
	 * 符号“#”匹配一个或多个词，符号“*”匹配不多不少一个词。因此“audit.#”能够匹配到“audit.irs.corporate”，但是“audit.*”
	 * 只会匹配到“audit.irs”。
	 **/
	@Bean
